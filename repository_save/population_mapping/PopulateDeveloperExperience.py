...
class PopulateDeveloperExperience(PopulateStructure):
    ...
    def generate_row(self, developer_experience):
        return ["'" + UtilityText.formate_text(developer_experience.get_name()) + "'","'" + developer_experience.language + "'",  int(developer_experience.pull_date) , str(developer_experience.developer.get_primary_key()) ]
